...
int flag1 ;
static GLfloat color1[4] = {0.5, 0.5, 0.5, 1.0};
...
/**
  ...
  building a display list since we do a lot of trigonometry here.
...
static void draw_name()
{
    ...
    DrawTextXY(-11.0,8,0.0,0.01,"COMPUTER GRARPHICS PROJECT");
    DrawTextXY(-6.0,6.5,0.0,0.01,"USING OPENGL");
    glColor3f(0.1,0.9,0.1);
    DrawTextXY(-11.0,3.0,0.0,0.01,"PES INSTITUTE OF TECHNOLOGY");

    glColor3f(1.0,0.8,0.0);
    DrawTextXY(-10.0,-1.0,0.0,0.008,"Submitted by:");
    DrawTextXY(-8.0,-2.0,0.0,0.005,"JAWAD AHMED  (1PE13CS064)");
    DrawTextXY(-8.0,-3.0,0.0,0.005,"BHARGAV  (1PE13CS044)");
...
static void draw(void)
{
    ...
    else
    {
        ...
        DrawTextXY(-13.0,11.0,0.0,0.01,"Rght click to choose gear from menu");
        glEnable(GL_LIGHTING);
        glEnable(GL_LIGHT0);
...
static void init(void)
{
  ...
  static GLfloat color4[4] = {0.8, 0.8, 0.8, 1.0};
  static GLfloat color5[4] = {0.8, 0.8, 0.8, 1.0};
  static GLfloat color6[4] = {0.8, 0.8, 0.8, 1.0};
  static GLfloat color7[4] = {0.8, 0.8, 0.8, 1.0};
  GLfloat lightIntensity[] = {0.99f, 0.99f, 0.99f, 0.99f};
